...
double dis_ptl(double, double, double, double, double);
double line_circle_delta(double, double, Point, double);
Point get_tangent(double, double, Point, double);
int equal(Point, Point);
double area_triangle (Point, Point, Point);
int point_in_triangle(Point, Point, Point, Point);
